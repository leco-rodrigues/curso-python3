...
print(f'Com R${dinheiro:.2f} é possível comprar US${dinheiro / 3.27:.2f}.')
    ...
    # Extra: Calcular quantos euros, yenes e pesos argentinos é possível comprar com esse valor. Considere: €1.00 = R$6.00; ¥1.00 = R$0.04; $1.00 = R$0.01
...
# Passo 5: Calcular quantos pesos argentino é possível comprar com esse valor (dinheiro / 0.01)
