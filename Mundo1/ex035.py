...
if a + b > c and a + c > b and b + c > a:
    print(f"{cores['negritoroxo']}Com {a}, {b} e {c}, é possível formar um triângulo.{cores['limpa']}")
else:
    print(f"{cores['negritoroxo']}Com {a}, {b} e {c}, NÃO é possível formar um triângulo.{cores['limpa']}")
# --------------------------------------------------------------------------------------------------------| Desafio [035]
